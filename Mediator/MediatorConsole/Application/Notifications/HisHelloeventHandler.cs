...
namespace DXQ.Study.Mediator.MediatorConsole.Application.Notifications {
    ...
    /// 他的打招呼事件处理器
    /// </summary>
    public class HisHelloeventHandler : INotificationHandler<HelloNotificationEvent> {
        /// <summary>
        /// 处理打招呼事件
        /// </summary>
        ...
        public Task Handle(HelloNotificationEvent notification, CancellationToken cancellationToken) {
            Console.WriteLine($"他的打招呼,提醒时间:{notification.HelloTime},提醒内容:{notification.HelloContent}");
