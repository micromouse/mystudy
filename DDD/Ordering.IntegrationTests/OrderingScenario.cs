...
namespace Ordering.IntegrationTests {
    ...
    public class OrderingScenario : OrderingScenarioBase {
        ...
        private string GetCreateOrder() {
            ...
            var order = new CreateOrderCommand(orderItems: orderItems, userId: Guid.NewGuid().ToString(), userName: "张爱玲",
                                               city: "成都市", street: "北大街", state: "四川省", country: "中国", zipcode: "610052",
                                               cardNumber: "4392250804822970", cardHolderName: "林徽因", cardExpiration: DateTime.Now.AddYears(10),
